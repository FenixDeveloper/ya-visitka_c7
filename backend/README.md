...
* **CLIENT_SECRET** - секрет, полученный при регистрации приложения в Yandex Passport
* **CURATOR_LIST** - массив с почтами кураторов, через которые можно получить доступ к административной части api

Заполнение конфигурационных параметров осуществляется в файле .env. Пример заполнения продемонстрирован в файле [.env.example](./.env.example)
...
**Frontend:** https://visitki-dev.team-7.practicum-team.ru - не доступен до объединения веток разработки frontend и backend
